...
M5128 = load_module("mts_5128_for_5130", SCRIPT_5128)

CHECKPOINT_ID = "5130"
MARKER = "MTS_5130_ARGUMENT_LOCAL_OUTER_COLLINEAR_A12"
REVISION = "argument-local-log-cauchy-chart-v2"
CHECKED_DATE = "2026-07-20"
JOB_KEY = "E040__S512503_N0000__A12__primary24"
BASE_ARGUMENT_ID = "A12"
SOURCE = POST / "source-intake" / "functional_rg" / CHECKPOINT_ID
INITIAL_REJECTED_GATE = SOURCE / "A12_initial_rejected_chart_gate.json"
...
M5128.SOURCE = SOURCE
M5128.PREFLIGHT_JSON = SOURCE / "A12_argument_local_outer_collinear_preflight.json"
M5128.GATE_JSON = SOURCE / "A12_argument_local_outer_collinear_chart_gate.json"
M5128.CATALOG_CSV = SOURCE / "A12_argument_local_outer_collinear_catalog.csv"
M5128.RESULT_JSON = SOURCE / "A12_argument_local_outer_collinear_replay_result.json"
M5128.STATUS_JSON = SOURCE / "A12_argument_local_outer_collinear_replay_status.json"
M5128.VALIDATION_CSV = (
    POST
    / "source-intake"
    / "mts_residuals"
    / "P8_Y5_BRR545_5130_VALIDATION.csv"
)
M5128.DOCUMENT = (
    POST
    / "5130-Y5-R2FR-argument-local-outer-collinear-A12-replay.md"
)
...
M5128.PRECISION_POLICY = {
    ...
    "selection": (
        "reuse the predeclared nested A01 precision pair only after the A12 "
        "default gate showed the same isolated small-beam residue asymmetry; "
        "acceptance thresholds and chart radii unchanged"
    ),
    "acceptance_threshold_changed": False,
}
M5128.EXPECTED_COUNTS_AFTER = {
    "completed_converged": 46,
