# 5142: E020/A10 KLT collinear pole-order proof
...
`E020__S512503_N0000__A10__primary24` passes those row-local conditions. Its maximum implemented
pole order is `1`; only special legs
`[2, 3]` retain the
...
pilot remains `{'completed_converged': 51, 'completed_unconverged': 0, 'failed': 0, 'missing': 509}`. This is a coefficient-integrand theorem, not a
