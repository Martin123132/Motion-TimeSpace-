# 5131 - argument-local outer-collinear preflight and A02 replay
...
`A02` preflight therefore derives the roots first and activates
...
The exact locked job `E040__S512503_N0000__A02__primary24` ends as `COMPLETED_CONVERGED`. It uses
`91` composite intervals and reaches maximum
adaptive relative error `3.657403050600277e-05`
against the unchanged `5e-5` tolerance. The causally corrected value is
`(378.2569567405178-53.46821170932667j)`.

The chart was called `864` times
inside `3276` target-profile evaluations.
