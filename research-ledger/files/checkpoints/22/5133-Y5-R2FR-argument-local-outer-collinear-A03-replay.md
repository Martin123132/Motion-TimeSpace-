# 5133 - argument-local outer-collinear preflight and A03 replay
...
`A03` preflight therefore derives the roots first and activates
...
The exact locked job `E040__S512503_N0000__A03__primary24` ends as `COMPLETED_CONVERGED`. It uses
`117` composite intervals and reaches maximum
adaptive relative error `4.6004993118058265e-05`
against the unchanged `5e-5` tolerance. The causally corrected value is
`(154.99664028824793+14.964922718214375j)`.

The chart was called `936` times
inside `4356` target-profile evaluations.
