...
```text
D:\Users\ollet\Desktop\Turn an intuitive research programme into a formal field-theoretic framework\Motion-TimeSpace--main\post-checkpoint-work\scripts\locked_2over27_BAO_only_release_test.py
```

Dry-run:

```text
D:\Users\ollet\Desktop\Turn an intuitive research programme into a formal field-theoretic framework\Motion-TimeSpace--main\post-checkpoint-work\runs\20260531-151952-locked-2over27-BAO-only-dryrun
```

Score run:

```text
D:\Users\ollet\Desktop\Turn an intuitive research programme into a formal field-theoretic framework\Motion-TimeSpace--main\post-checkpoint-work\runs\20260531-151959-locked-2over27-BAO-only-score
```
