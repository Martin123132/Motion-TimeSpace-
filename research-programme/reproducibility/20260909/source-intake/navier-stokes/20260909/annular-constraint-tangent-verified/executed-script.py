...
def run():
    ...
    destination = intake / 'annular-constraint-tangent-verified'
    ...
    try:
        ...
        for sample in prior['samples']:
            ...
            constants = {'b2': 0.0, 'b3': 0.0, 'm_chi': 0.0, 'Lambda': 0.0} if case_name == 'canonical' else {'b2': 0.05, 'b3': 0.02, 'm_chi': 0.2, 'Lambda': 0.001}
