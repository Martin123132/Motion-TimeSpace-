...
def run():
    ...
    save()
    try:
        folder = intake / "annular-raw-volterra-C3-time-jets-trajectory"
        ...
        for name in ["annular_raw_volterra_time_jets_20260909.py", "derive_annular_raw_volterra_C3_normal_reconstruction_20260909.py", "annular_projected_volterra_time_jets_20260909.py", "derive_annular_projected_volterra_normal_reconstruction_20260909.py", "annular_current_normal_reconstruction_20260909.py", "derive_annular_current_normal_reconstruction_20260909.py", "annular_coupled_curvature_transfer_20260909.py", "annular_curvature_timejet_transfer_20260909.py", "annular_current_corner_compatibility_20260909.py"]:
        ...
        for case_name in ["canonical", "nonlinear_modulated"]:
            ...
            for entry in owner["runs"]:
                ...
                for method in ["poly7", "poly9"]:
                    ...
                    if entry["intervals"] == 128 and entry["time"] == 0.1:
        ...
        for case_name in ["canonical", "nonlinear_modulated"]:
            for time_value in [0.1, 0.3]:
                first, second = [stored[case_name, time_value, 512, method] for method in ["poly7", "poly9"]]
                ...
                for method in ["poly7", "poly9"]:
                    for quantity in ["Z", "K1"]:
                        low, middle, high = [stored[case_name, time_value, intervals, method]["nodes_" + quantity + "_variation"] for intervals in [128, 256, 512]]
