...
Latest analytic/numerical continuation: actual nonlinear initial radial/Legendre constraints now solved for GR/P(X) and Gram, canonical/nonlinear, N16/32/64: twelve square Newton solves, one step each, raw free residual<=4.77e-13; no pseudoinverse or projected equations. Explicit local boundary Routh functional fixes inner mass, outer clock and scalar endpoint velocities; all lapse rows free. Differentiated constraints determine lapse/scalar/mass rates, independently verified by neighboring nonlinear root families. Remaining shift/mass-flux disagreement is nonzero in BOTH branches; Gram larger but decreases about fourfold per refinement, to9.13e-7/9.26e-7 atN64. Exact boundary/lifting forcing split shows deleting those terms worsens it. Completed196/196+134/134+40/40 checks; not full time-compatible evolution or local-GR proof
...
Active next target: derive the local time-reparametrization/Ward identity of the SAME mixed ADM+Gram action, with scalar lifting and boundary work, and express/bound the saved R_shift=B(mu_dot_constraint-mu_dot_flux) as explicit reconstruction/product-rule remainders. Starting chain rule delta I=f I_t-[D(fq)-fDq-qDf]. If slope/interface dynamics are needed, derive them from the action, not by fitting I_t or a mass-flux counterterm. Initial constraint roots and nonzero boundary reactions are already saved: do not repeat that hunt. Main note DERIVATION-20260909-constrained-initial-slice-solve-and-mass-flux-tangent.md sections4-6. No exact shift closure, full degree-of-freedom/global boundary/local-GR promotion; do not restart old failed evolution. Full GR/source calibration/first-u remain open; heavy D4/stellar paused
Expected active MTS workers: none; constraint, independent tangent and work-split validators all terminal and exited. At most two modest single-core BelowNormal jobs; NO subagents or shared-process shutdowns. Safe check-in maximum4hours
