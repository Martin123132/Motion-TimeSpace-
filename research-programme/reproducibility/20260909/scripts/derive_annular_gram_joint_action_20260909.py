...
def run():
    ...
    from annular_gram_joint_action_20260909 import action, coefficient_jets, coefficient_pairing, gram_matrices, matter_values, potential, potential_gradient, potential_hessian_pair, principal_coefficient, remainder
    ...
    destination = intake / "annular-Gram-joint-action-derived"
