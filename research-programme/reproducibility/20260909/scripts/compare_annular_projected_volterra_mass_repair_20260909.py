...
def run():
    ...
    destination = intake / "annular-projected-volterra-matched-comparison"
    ...
    try:
        ...
        matched_initials = [name for name in original_inputs if "annular-analytic-third-corner-initial-data/" in name and name.endswith(".json")]
