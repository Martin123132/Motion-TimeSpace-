...
This directory contains the post-checkpoint formalization workbench prepared for public review.
...
- `source-intake/mts_residuals/` — compact CSV/register artifacts used by residual and theorem-gate workflows.
