...
OUTPUT = FUNCTIONAL_RG / "5503"
WORK = OUTPUT / "work-v1"

SCRIPT_5502 = SCRIPTS / "Y5_R2FR_5502_D4_parent_v58_high_t_sibling_gate.py"
SOURCE_STATE = FUNCTIONAL_RG / "5502" / "work-v1" / "E07__U051__RIGHT_CONNECTOR__CUBOID__6df3d70a73e4618b.json"
RESULT_5502 = FUNCTIONAL_RG / "5502" / "D4_parent_v58_high_t_sibling_result.json"
VALIDATION_5502 = FUNCTIONAL_RG / "5502" / "P8_Y5_BRR5501_5502_VALIDATION.csv"
SOURCE_REGISTER_5502 = FUNCTIONAL_RG / "5502" / "source_register.csv"
NODE_AUDIT_5502 = FUNCTIONAL_RG / "5502" / "D4_parent_v58_high_t_sibling_audit.csv"
...
NODE_AUDIT = OUTPUT / "D4_parent_v58_x_sibling_audit.csv"
...
VALIDATION = OUTPUT / "P8_Y5_BRR5502_5503_VALIDATION.csv"
STATUS = OUTPUT / "status.json"
RESULT = OUTPUT / "D4_parent_v58_x_sibling_four_leaf_closure_result.json"
DOCUMENT = POST / "5503-Y5-R2FR-D4-parent-v58-x-sibling-four-leaf-closure-gate.md"

CHECKPOINT = 5503
REVISION = "D4-parent-v58-x-sibling-four-leaf-closure-v1"
PARENT_V58_REVISION = "D4-deformed-contour-regular-away-W3-v58-adaptive-stable-edge-local-T2-union"
EXPECTED_PATH = "R_E0S_E0S_E1S_X0S_X1S"
PARENT_PATH = "R_E0S_E0S_E1S_X0S"
SOURCE_LEAF_PATHS = {
...
EXPECTED_SOURCE_COUNTS = (182, 4, 0)
EXPECTED_SOURCE_WITNESSES = 63
EXPECTED_SCRIPT_5502_SHA256 = "7fe7833197b124ed9c228492f82cda8ba3810278b38c026ce7042fee9405a4d8"
EXPECTED_SOURCE_STATE_SHA256 = "fa7e401c5981d83c12dffdbb9e4cc8b9e9d1847fe4393f3509fcde883fca892c"
EXPECTED_RESULT_5502_SHA256 = "8e40ee678a76a58e99706054c640388e94918d56b8b7214f865d39e9a0129623"
EXPECTED_VALIDATION_5502_SHA256 = "98918d686f8669f971aec5730851a32a68c8adcb34ea53a64cacfdb8329aa6bd"
EXPECTED_SOURCE_REGISTER_5502_SHA256 = "305b96cdbc48740f5ccb200dd583604e42eef640af4aae9d7f0555e5f38d0894"
EXPECTED_NODE_AUDIT_5502_SHA256 = "642e62b6a1e94490fabb4641b82373db2cf8349f142e2bcce94e0d0d60b025ad"
...
def source_paths(
    ...
    return tuple(dict.fromkeys((
        ...
        *base_5502.source_paths(base_5501, base_5500, base_5499, base_5498, base_5496, base_5495),
        SCRIPT_5502,
        SOURCE_STATE,
        RESULT_5502,
        VALIDATION_5502,
        SOURCE_REGISTER_5502,
        NODE_AUDIT_5502,
        CERTIFICATE_5496,
    )))
...
def boxes_overlap(base_5498: Any, left: dict[str, Any], right: dict[str, Any]) -> bool:
    return all(
        min(base_5498.exact_coordinate(left[upper]), base_5498.exact_coordinate(right[upper]))
        > max(base_5498.exact_coordinate(left[lower]), base_5498.exact_coordinate(right[lower]))
        for lower, upper in (
...
def exact_four_leaf_closure(base_5498: Any, state: dict[str, Any]) -> tuple[bool, float, float, float, float]:
    leaf_paths = SOURCE_LEAF_PATHS | {EXPECTED_PATH}
...
def render_document(payload: dict[str, Any], base_5467: Any) -> None:
    lines = [
        "# 5503: D4 parent-v58 x-sibling four-leaf closure gate",
        "",
        "Checkpoint 5502 is hash locked. The remaining x sibling is evaluated once without revisiting the certified three-leaf region.",
        "",
        ...
        "",
        f"Exact four-leaf parent closure: `{payload['exact_parent_four_leaf_closure']}`. Union denominator lower: `{payload['parent_union_amplitude_denominator_abs_lower']}`. Union Jacobian lower: `{payload['parent_union_collision_jacobian_abs_lower']}`.",
        "",
        f"**{payload['decision']}**",
        "",
...
def main() -> int:
    ...
    base_5502 = load_module("mts_5502_for_5503", SCRIPT_5502)
    base_5501 = load_module("mts_5501_for_5503", base_5502.SCRIPT_5501)
    base_5500 = load_module("mts_5500_for_5503", base_5501.SCRIPT_5500)
    base_5499 = load_module("mts_5499_for_5503", base_5500.SCRIPT_5499)
    base_5498 = load_module("mts_5498_for_5503", base_5499.SCRIPT_5498)
    base_5496 = load_module("mts_5496_for_5503", base_5498.SCRIPT_5496)
    base_5495 = load_module("mts_5495_for_5503", base_5496.SCRIPT_5495)
    base_5467 = load_module("mts_5467_for_5503", base_5495.SCRIPT_5467)
    base_5468 = load_module("mts_5468_for_5503", base_5495.SCRIPT_5468)
    base_5469 = load_module("mts_5469_for_5503", base_5495.SCRIPT_5469)
    base_5472 = load_module("mts_5472_for_5503", base_5495.SCRIPT_5472)
    base_5474 = load_module("mts_5474_for_5503", base_5495.SCRIPT_5474)
    base_5476 = load_module("mts_5476_for_5503", base_5495.SCRIPT_5476)
    base_5478 = load_module("mts_5478_for_5503", base_5495.SCRIPT_5478)
    base_5480 = load_module("mts_5480_for_5503", base_5495.SCRIPT_5480)
    base_5483 = load_module("mts_5483_for_5503", base_5495.SCRIPT_5483)
    base_5490 = load_module("mts_5490_for_5503", base_5495.SCRIPT_5490)
    base_5493 = load_module("mts_5493_for_5503", base_5495.SCRIPT_5493)
    ...
    paths = source_paths(base_5502, base_5501, base_5500, base_5499, base_5498, base_5496, base_5495)
    missing = [str(path) for path in paths if not path.is_file()]
    if missing:
        raise FileNotFoundError(f"missing sources: {missing}")
    inherited_hashes = {
        "script_5502": base_5499.digest(SCRIPT_5502),
        "source_state": base_5499.digest(SOURCE_STATE),
        "result_5502": base_5499.digest(RESULT_5502),
        "validation_5502": base_5499.digest(VALIDATION_5502),
        "source_register_5502": base_5499.digest(SOURCE_REGISTER_5502),
        "node_audit_5502": base_5499.digest(NODE_AUDIT_5502),
        "certificate_5496": base_5499.digest(CERTIFICATE_5496),
    }
    expected_hashes = {
        "script_5502": EXPECTED_SCRIPT_5502_SHA256,
        "source_state": EXPECTED_SOURCE_STATE_SHA256,
        "result_5502": EXPECTED_RESULT_5502_SHA256,
        "validation_5502": EXPECTED_VALIDATION_5502_SHA256,
        "source_register_5502": EXPECTED_SOURCE_REGISTER_5502_SHA256,
        "node_audit_5502": EXPECTED_NODE_AUDIT_5502_SHA256,
        "certificate_5496": EXPECTED_CERTIFICATE_5496_SHA256,
    }
    if inherited_hashes != expected_hashes:
        raise RuntimeError("checkpoint-5503 inherited source hash mismatch")
    source = base_5499.read_json(SOURCE_STATE)
    result_5502 = base_5499.read_json(RESULT_5502)
    validation_5502 = base_5499.read_csv(VALIDATION_5502)
    register_5502 = base_5499.read_csv(SOURCE_REGISTER_5502)
    ...
    source_certified = (
        result_5502.get("decision") == "PARENT_V58_EXACT_LOW_XT_THREE_LEAF_UNION_CERTIFIED__ADVANCE_FRONTIER"
        and result_5502.get("exact_parent_three_leaf_closure") is True
        and int(result_5502.get("failed_validation_count", -1)) == 0
        and all(base_5499.truth(row.get("passed")) for row in validation_5502)
        and base_5499.source_register_is_current(register_5502)
    ...
    if not source_certified:
        raise RuntimeError("checkpoint-5502 source is not current and certified")
    ...
    if arguments.dry_run:
        print(json.dumps({
            ...
            "three_leaf_parent_closed": result_5502["exact_parent_three_leaf_closure"],
    ...
    if STATE.is_file():
        ...
        if state.get("checkpoint_5503", {}).get("source_state_sha256") != EXPECTED_SOURCE_STATE_SHA256:
            raise RuntimeError("checkpoint-5503 output source mismatch")
    else:
        WORK.mkdir(parents=True, exist_ok=True)
        state = carry_forward(base_5499, source)
        base_5467.atomic_json(STATE, state, compact=True)
    if not state["checkpoint_5503"]["records"]:
        state = base_5500.process_atomic_node(
            ...
            arguments.maximum_refinement_depth, "checkpoint_5503", STATE,
            "checkpoint_5503_parent_v58",
        )
    records = list(state["checkpoint_5503"]["records"])
    record = records[0]
    ...
    closure, closure_error, path_upper, denominator_lower, jacobian_lower = exact_four_leaf_closure(base_5498, state)
    carry = state["checkpoint_5503"]
    after_formalization = base_5467.formalization_snapshot()
    validations = [
        check("all_sources_exist", not missing, len(paths)),
        check("checkpoint_5502_evidence_is_hash_locked", inherited_hashes == expected_hashes, inherited_hashes),
        check("checkpoint_5502_frontier_and_three_leaf_union_are_certified", source_certified, result_5502.get("decision")),
        check("source_frontier_is_exact_182_4_0", source_counts == EXPECTED_SOURCE_COUNTS, source_counts),
        ...
        check("exactly_one_x_sibling_is_committed", len(records) == 1 and record["refinement_path"] == EXPECTED_PATH, record["refinement_path"]),
        ...
        check("atomic_record_replays_exactly", base_5500.replay_records(source, state, "checkpoint_5503"), record["outcome"]),
        ...
        check("four_leaf_parent_closure_requires_four_positive_leaves", not closure or (record["outcome"] == "ACCEPTED" and closure_error == 0.0 and path_upper > 0.0 and denominator_lower > 0.0 and jacobian_lower > 0.0), closure),
        ...
        check("broad_claims_remain_false", not state["valid_for_parent_v58_active_cuboid"] and not state["valid_for_full_outer_parent_leaf_enclosure"] and not state["valid_for_D4_event_local_W3_bound"] and not state["valid_for_all_operator_local_GR_claim"] and not state["valid_for_full_MTS_claim"], "one x sibling"),
    ]
    failed = [row for row in validations if not row["passed"]]
    decision = (
        "PARENT_V58_EXACT_XT_FOUR_LEAF_UNION_CERTIFIED__ADVANCE_FRONTIER"
        if not failed and closure
        else (
            "PARENT_V58_X_SIBLING_CERTIFIED__CONTINUE_REFINEMENT"
            if not failed
            else "PARENT_V58_X_SIBLING_NOT_CERTIFIED"
        )
    )
    payload = {
        "checkpoint": CHECKPOINT,
        ...
        "exact_parent_four_leaf_closure": closure,
        ...
        "valid_for_parent_v58_x_sibling": not failed,
        "valid_for_parent_v58_xt_parent": not failed and closure,
    ...
    print(json.dumps({key: payload[key] for key in (
        ...
        "exact_parent_four_leaf_closure", "parent_union_amplitude_denominator_abs_lower",
        "parent_union_collision_jacobian_abs_lower", "new_v58_application_count",
