...
OUTPUT = FUNCTIONAL_RG / "5502"
WORK = OUTPUT / "work-v1"

SCRIPT_5501 = SCRIPTS / "Y5_R2FR_5501_D4_parent_v58_high_x_sibling_gate.py"
SOURCE_STATE = (
    FUNCTIONAL_RG
    / "5501"
    / "work-v1"
...
RESULT_5501 = FUNCTIONAL_RG / "5501" / "D4_parent_v58_high_x_sibling_result.json"
VALIDATION_5501 = FUNCTIONAL_RG / "5501" / "P8_Y5_BRR5500_5501_VALIDATION.csv"
SOURCE_REGISTER_5501 = FUNCTIONAL_RG / "5501" / "source_register.csv"
NODE_AUDIT_5501 = FUNCTIONAL_RG / "5501" / "D4_parent_v58_high_x_sibling_audit.csv"
...
NODE_AUDIT = OUTPUT / "D4_parent_v58_high_t_sibling_audit.csv"
...
VALIDATION = OUTPUT / "P8_Y5_BRR5501_5502_VALIDATION.csv"
STATUS = OUTPUT / "status.json"
RESULT = OUTPUT / "D4_parent_v58_high_t_sibling_result.json"
DOCUMENT = POST / "5502-Y5-R2FR-D4-parent-v58-high-t-sibling-gate.md"

CHECKPOINT = 5502
REVISION = "D4-parent-v58-high-t-sibling-gate-v1"
PARENT_V58_REVISION = "D4-deformed-contour-regular-away-W3-v58-adaptive-stable-edge-local-T2-union"
EXPECTED_PATH = "R_E0S_E0S_E1S_X0S_X0S_T1S"
LOW_T_LOW_X_PATH = "R_E0S_E0S_E1S_X0S_X0S_T0S_X0S"
LOW_T_HIGH_X_PATH = "R_E0S_E0S_E1S_X0S_X0S_T0S_X1S"
PARENT_PATH = "R_E0S_E0S_E1S_X0S_X0S"
...
EXPECTED_SOURCE_COUNTS = (181, 5, 0)
EXPECTED_SOURCE_WITNESSES = 63
EXPECTED_SCRIPT_5501_SHA256 = "8df999ce2084911004a8ae7b393bf4ba7e359d61e16595c17392e237360bdef5"
EXPECTED_SOURCE_STATE_SHA256 = "83831a5709eed87c5d82804db3c4b87f3a8d4a8ce3184ca591cf95984dac4015"
EXPECTED_RESULT_5501_SHA256 = "4f0203641f8c2adf0d3f79c21df73da4c950b2be14bfa9897edc5c2aecfb8ab5"
EXPECTED_VALIDATION_5501_SHA256 = "5b617411755acc445a0c2408f1abdc503c560bde86cb8680a5aff97ae676f640"
EXPECTED_SOURCE_REGISTER_5501_SHA256 = "97907c3ce965077ae40803e5f64e55611f71cde615eee8d902aebee003841a03"
EXPECTED_NODE_AUDIT_5501_SHA256 = "3bc0b591e4fcb5c0532fd62eb4475c4e72fc57e1c6df9ff090e626664e54ba60"
    ...
    return tuple(
        dict.fromkeys(
            (
                ...
                *base_5501.source_paths(base_5500, base_5499, base_5498, base_5496, base_5495),
                SCRIPT_5501,
                SOURCE_STATE,
                RESULT_5501,
                VALIDATION_5501,
                SOURCE_REGISTER_5501,
                NODE_AUDIT_5501,
                CERTIFICATE_5496,
            )
        )
...
def boxes_overlap(base_5498: Any, left: dict[str, Any], right: dict[str, Any]) -> bool:
    return all(
        min(
            base_5498.exact_coordinate(left[upper]),
            base_5498.exact_coordinate(right[upper]),
        )
        > max(
            base_5498.exact_coordinate(left[lower]),
            base_5498.exact_coordinate(right[lower]),
        )
        for lower, upper in (
...
def exact_three_leaf_closure(
    base_5498: Any,
    state: dict[str, Any],
) -> tuple[bool, float, float, float, float]:
    leaf_paths = {LOW_T_LOW_X_PATH, LOW_T_HIGH_X_PATH, EXPECTED_PATH}
    leaves = [
        row for row in state["accepted"] if row.get("refinement_path") in leaf_paths
    ]
    parent = next(
        row
    ...
    disjoint = all(
        not boxes_overlap(base_5498, left, right)
...
def render_document(payload: dict[str, Any], base_5467: Any) -> None:
    lines = [
        "# 5502: D4 parent-v58 high-t sibling gate",
        "",
        "The checkpoint-5501 frontier is hash locked. Its exact high-t sibling is evaluated once under unchanged parent v58, without revisiting the certified low-t X2 union.",
        "",
        f"High-t outcome: `{payload['node_outcome']}` in `{payload['node_runtime_seconds']}` seconds. Frontier: `{payload['accepted_subcuboid_count']}/{payload['pending_subcuboid_count']}/{payload['unresolved_subcuboid_count']}`.",
        "",
        f"Exact three-leaf parent closure: `{payload['exact_parent_three_leaf_closure']}`. Union amplitude-denominator lower: `{payload['parent_union_amplitude_denominator_abs_lower']}`. Union collision-Jacobian lower: `{payload['parent_union_collision_jacobian_abs_lower']}`.",
        "",
        f"**{payload['decision']}**",
        "",
...
def main() -> int:
    ...
    base_5501 = load_module("mts_5501_for_5502", SCRIPT_5501)
    base_5500 = load_module("mts_5500_for_5502", base_5501.SCRIPT_5500)
    base_5499 = load_module("mts_5499_for_5502", base_5500.SCRIPT_5499)
    base_5498 = load_module("mts_5498_for_5502", base_5499.SCRIPT_5498)
    base_5496 = load_module("mts_5496_for_5502", base_5498.SCRIPT_5496)
    base_5495 = load_module("mts_5495_for_5502", base_5496.SCRIPT_5495)
    base_5467 = load_module("mts_5467_for_5502", base_5495.SCRIPT_5467)
    base_5468 = load_module("mts_5468_for_5502", base_5495.SCRIPT_5468)
    base_5469 = load_module("mts_5469_for_5502", base_5495.SCRIPT_5469)
    base_5472 = load_module("mts_5472_for_5502", base_5495.SCRIPT_5472)
    base_5474 = load_module("mts_5474_for_5502", base_5495.SCRIPT_5474)
    base_5476 = load_module("mts_5476_for_5502", base_5495.SCRIPT_5476)
    base_5478 = load_module("mts_5478_for_5502", base_5495.SCRIPT_5478)
    base_5480 = load_module("mts_5480_for_5502", base_5495.SCRIPT_5480)
    base_5483 = load_module("mts_5483_for_5502", base_5495.SCRIPT_5483)
    base_5490 = load_module("mts_5490_for_5502", base_5495.SCRIPT_5490)
    base_5493 = load_module("mts_5493_for_5502", base_5495.SCRIPT_5493)
    ...
    paths = source_paths(base_5501, base_5500, base_5499, base_5498, base_5496, base_5495)
    missing = [str(path) for path in paths if not path.is_file()]
    if missing:
        raise FileNotFoundError(f"missing sources: {missing}")
    inherited_hashes = {
        "script_5501": base_5499.digest(SCRIPT_5501),
        "source_state": base_5499.digest(SOURCE_STATE),
        "result_5501": base_5499.digest(RESULT_5501),
        "validation_5501": base_5499.digest(VALIDATION_5501),
        "source_register_5501": base_5499.digest(SOURCE_REGISTER_5501),
        "node_audit_5501": base_5499.digest(NODE_AUDIT_5501),
        "certificate_5496": base_5499.digest(CERTIFICATE_5496),
    }
    expected_hashes = {
        "script_5501": EXPECTED_SCRIPT_5501_SHA256,
        "source_state": EXPECTED_SOURCE_STATE_SHA256,
        "result_5501": EXPECTED_RESULT_5501_SHA256,
        "validation_5501": EXPECTED_VALIDATION_5501_SHA256,
        "source_register_5501": EXPECTED_SOURCE_REGISTER_5501_SHA256,
        "node_audit_5501": EXPECTED_NODE_AUDIT_5501_SHA256,
        "certificate_5496": EXPECTED_CERTIFICATE_5496_SHA256,
    }
    if inherited_hashes != expected_hashes:
        raise RuntimeError("checkpoint-5502 inherited source hash mismatch")
    source = base_5499.read_json(SOURCE_STATE)
    result_5501 = base_5499.read_json(RESULT_5501)
    validation_5501 = base_5499.read_csv(VALIDATION_5501)
    register_5501 = base_5499.read_csv(SOURCE_REGISTER_5501)
    ...
    source_certified = (
        result_5501.get("decision") == "PARENT_V58_LOW_T_EXACT_X2_UNION_CERTIFIED__ADVANCE_HIGH_T"
        and result_5501.get("exact_low_t_parent_closure") is True
        and int(result_5501.get("failed_validation_count", -1)) == 0
        and all(base_5499.truth(row.get("passed")) for row in validation_5501)
        and base_5499.source_register_is_current(register_5501)
    ...
    if not source_certified:
        raise RuntimeError("checkpoint-5501 source is not current and certified")
            ...
            json.dumps(
                {
                    ...
                    "low_t_parent_closed": result_5501["exact_low_t_parent_closure"],
    ...
    if STATE.is_file():
        ...
        if state.get("checkpoint_5502", {}).get("source_state_sha256") != EXPECTED_SOURCE_STATE_SHA256:
            raise RuntimeError("checkpoint-5502 output source mismatch")
    else:
        WORK.mkdir(parents=True, exist_ok=True)
        state = carry_forward(base_5499, source)
        base_5467.atomic_json(STATE, state, compact=True)
    if not state["checkpoint_5502"]["records"]:
        state = base_5500.process_atomic_node(
            ...
            "checkpoint_5502",
            STATE,
            "checkpoint_5502_parent_v58",
        )
    records = list(state["checkpoint_5502"]["records"])
    record = records[0]
    ...
    closure, closure_error, path_upper, denominator_lower, jacobian_lower = exact_three_leaf_closure(base_5498, state)
    carry = state["checkpoint_5502"]
    after_formalization = base_5467.formalization_snapshot()
    validations = [
        check("all_sources_exist", not missing, len(paths)),
        check("checkpoint_5501_evidence_is_hash_locked", inherited_hashes == expected_hashes, inherited_hashes),
        check("checkpoint_5501_frontier_and_low_t_union_are_certified", source_certified, result_5501.get("decision")),
        check("source_frontier_is_exact_181_5_0", source_counts == EXPECTED_SOURCE_COUNTS, source_counts),
        ...
        check("exactly_one_high_t_sibling_is_committed", len(records) == 1 and record["refinement_path"] == EXPECTED_PATH, record["refinement_path"]),
        ...
        check("atomic_record_replays_exactly", base_5500.replay_records(source, state, "checkpoint_5502"), record["outcome"]),
        ...
        check("three_leaf_parent_closure_is_only_claimed_from_positive_leaves", not closure or (record["outcome"] == "ACCEPTED" and closure_error == 0.0 and path_upper > 0.0 and denominator_lower > 0.0 and jacobian_lower > 0.0), closure),
        ...
        check("broad_claims_remain_false", not state["valid_for_parent_v58_active_cuboid"] and not state["valid_for_full_outer_parent_leaf_enclosure"] and not state["valid_for_D4_event_local_W3_bound"] and not state["valid_for_all_operator_local_GR_claim"] and not state["valid_for_full_MTS_claim"], "one high-t node"),
    ]
    failed = [row for row in validations if not row["passed"]]
    decision = (
        "PARENT_V58_EXACT_LOW_XT_THREE_LEAF_UNION_CERTIFIED__ADVANCE_FRONTIER"
        if not failed and closure
        else (
            "PARENT_V58_HIGH_T_SIBLING_CERTIFIED__CONTINUE_REFINEMENT"
            if not failed
            else "PARENT_V58_HIGH_T_SIBLING_NOT_CERTIFIED"
        )
    )
    payload = {
        "checkpoint": CHECKPOINT,
        ...
        "exact_parent_three_leaf_closure": closure,
        ...
        "valid_for_parent_v58_high_t_sibling": not failed,
        "valid_for_parent_v58_low_xt_parent": not failed and closure,
        ...
        json.dumps(
            {
                ...
                for key in (
                    ...
                    "exact_parent_three_leaf_closure",
                    "parent_union_amplitude_denominator_abs_lower",
                    "parent_union_collision_jacobian_abs_lower",
