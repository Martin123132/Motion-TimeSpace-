...
from annular_P2_graded_embedding_exact_20260919 import GradedSourceAction, nested_embedding
...
def main():
    evidence = EvidenceRun('annular-P2-graded-source-algebra-attempt04', __file__)
    try:
