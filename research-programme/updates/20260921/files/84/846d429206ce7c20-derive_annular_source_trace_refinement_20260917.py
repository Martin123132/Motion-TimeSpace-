...
def main():
    ...
    try:
        ...
        for count in [33,65,129,257,513,1025,2049]:
            ...
            evidence.check(str(count)+'_unit_hinge_jump',abs(system.jump @ hinge-1)<2e-11)
            ...
            evidence.check(str(count)+'_piecewise_quintic_jump',abs(float(system.jump @ values)-expected_jump)<2e-11)
