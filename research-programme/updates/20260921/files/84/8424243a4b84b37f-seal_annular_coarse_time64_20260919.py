...
def main():
    ...
    destination = intake/'annular-coarse-time64-final-integrity.json'
    snapshot = intake/'annular-coarse-time64-resume-snapshot.md'
    executed = intake/'annular-coarse-time64-executed-sealer.py'
    suffixes = ['force', 'response-summary', 'points', 'responses', 'controls', 'sampling', 'richardson']
    tables = [intake/('annular-coarse-time64-'+suffix+'.csv') for suffix in suffixes]
    ...
    try:
        ...
        for name in ['run_annular_coarse_time64_20260919.py', 'derive_annular_coarse_time64_response_20260919.py',
                'seal_annular_coarse_time64_20260919.py']:
