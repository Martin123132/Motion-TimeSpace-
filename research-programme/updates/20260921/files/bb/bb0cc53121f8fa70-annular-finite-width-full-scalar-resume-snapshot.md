...
Read DERIVATION-20260913-off-shell-finite-width-action-and-clock-coframe.md first. PRIVATE. No GitHub, subagents, new spacetime evolution, or edits to old evidence. One BelowNormal single-core worker at a time; safe check-in within four hours. Old WORKING old-action branch and original79/177 new-action data remain unchanged. Main attempt02 completed 60 checks; independent final verification pending at this snapshot.
