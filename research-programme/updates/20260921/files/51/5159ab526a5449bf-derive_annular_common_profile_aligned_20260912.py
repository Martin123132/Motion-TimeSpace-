...
def run():
    ...
    from annular_canonical_common_profile_aligned_20260912 import CommonProfile, RefinedContext, RefinedPreparation, RefinedFields
    ...
    save()
    try:
        prior_path = root / 'source-intake/navier-stokes/20260911/annular-canonical-trace-final-integrity.json'
        own(prior_path)
        ...
        for name in ['annular_canonical_common_profile_aligned_20260912.py', 'annular_inherited_knot_link_quadrature_20260912.py', Path(__file__).name]:
