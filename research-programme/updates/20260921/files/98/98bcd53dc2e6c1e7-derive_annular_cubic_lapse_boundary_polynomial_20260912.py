...
def run():
    ...
    from annular_cubic_lapse_boundary_polynomial_20260912 import CubicContext, CubicPreparation, CubicFields, evaluate_cubic_initial
    ...
    try:
        ...
        for name in ['annular_cubic_lapse_boundary_polynomial_20260912.py', Path(__file__).name]:
