...
class RefinedContext:
    def __init__(self, common, intervals, branch):
        if intervals != 128 or branch not in ['GR', 'metric_Gram']:
        ...
        self.links = InheritedKnotLinkQuadrature(basis, common.coarse.knots)
        self.check_links = InheritedKnotLinkQuadrature(basis, common.coarse.knots, order=12)
