...
def main():
    ...
    destination = intake/'annular-full-force-final-integrity.json'
    snapshot = intake/'annular-full-force-resume-snapshot.md'
    executed = intake/'annular-full-force-executed-sealer.py'
    ...
    tables = [intake/('annular-full-force-'+suffix+'.csv') for suffix in suffixes]
    ...
    try:
        ...
        failures = []
        for path in sorted(intake.glob('annular-full-force-*/status.json')):
        ...
        note = root/'DERIVATION-20260919-full-source-force-spatial-budget.md'
        ...
        for name in ['annular_full_schur_force_20260919.py','annular_position_action_response_20260919.py',
                ...
                'derive_annular_full_force_transport_v2_20260919.py','seal_annular_full_force_20260919.py']:
        ...
        check('scoped_successful_check_count',count == 756)
