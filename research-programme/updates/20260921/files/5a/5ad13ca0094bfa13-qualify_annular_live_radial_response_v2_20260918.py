...
from annular_live_radial_response_20260918 import SnapshotLoads, adjoint_integrals
...
def main():
    evidence = EvidenceRun('annular-live-radial-response-attempt02', __file__)
    try:
        ...
        evidence.report.update(no_forward_evolution=True, frozen_canonical_density_radial_variations_only=True,
            interpolation_knots_are_radial_integration_boundaries=True,
            supersedes_integration_control_failure='annular-live-radial-response-attempt01',
