...
def run():
    ...
    destination = intake / 'annular-frozen-second-jet-control-attempt01'
    ...
    try:
        ...
        def transported_gram(model, result, time):
            ...
            return {'P': gramP, 'N': gramN, 'chi': scalar}
        ...
        for branch in ['GR', 'metric_Gram']:
            ...
            check(branch + '_actual_action_Cddot_independent_time_differences', differences[-1]['max_error'] < 2e-5, differences)
