...
def main():
    ...
    try:
        ...
        evidence.report.update(original_action_unchanged=True, finite_future_trajectories_read=False,
            ...
            supersedes_failed_time_control=['annular-frozen-initial-layer-attempt01', 'annular-frozen-initial-layer-attempt02'], unchanged_force_time_control_threshold=2e-10)
        ...
        for count in protocol['counts']:
            for branch in protocol['branches']:
                ...
                controls = []
                settings = [('standard', 3e-14, 3e-16, .01), ('tight', 3e-14, 3e-18, .002)]
