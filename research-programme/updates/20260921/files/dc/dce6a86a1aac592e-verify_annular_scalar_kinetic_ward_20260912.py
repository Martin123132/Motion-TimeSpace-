...
def run():
    ...
    enlarged = False
    source = intake / 'annular-scalar-kinetic-pair-attempt01'
    destination = intake / 'annular-scalar-kinetic-ward-control-attempt01'
    ...
    try:
        ...
        for branch in ['GR', 'metric_Gram']:
            for higher in [False, True]:
                ...
                record['kinetic_matched_new_scalar_momentum_space'] = True
