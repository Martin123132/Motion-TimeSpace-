...
def run():
    ...
    try:
        ...
        for name in ['annular_canonical_trace_context_20260911.py', 'annular_canonical_trace_projection_stable_20260911.py', Path(__file__).name]:
        ...
        for branch in ['GR', 'metric_Gram']:
            ...
            check(branch + '_momentum_transparency', record['momentum_rate_change'] < 1e-7 and fixed_family_error < 1e-10, record['momentum_rate_change'])
