...
from annular_candidate_anderson_midpoint_20260921 import midpoint_step
...
def main():
    ...
    evidence = EvidenceRun('annular-candidate-longer-'+args.horizon+'-attempt02', __file__)
    ...
    try:
        ...
        control_path = evidence.output.parent/'annular-candidate-accelerated-midpoint-control-attempt01/status.json'
