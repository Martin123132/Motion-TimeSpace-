...
def main():
    ...
    own_core(1)
    evidence = EvidenceRun('annular-P2-saved-impulse-coarse16-'+args.branch+'-attempt01', __file__)
    try:
        ...
        evidence.report.update(github_action=False, subagents_used=False, branch=args.branch,
            ...
            duration=4e-5, maximum_wall_seconds=1800., coarse_time_refinement_only=True, core=1,
