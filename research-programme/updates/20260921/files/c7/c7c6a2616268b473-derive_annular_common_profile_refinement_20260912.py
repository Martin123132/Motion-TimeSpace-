...
def run():
    ...
    from annular_canonical_common_profile_refinement_20260912 import CommonProfile, RefinedContext, RefinedPreparation, RefinedFields
    ...
    try:
        ...
        for name in ['annular_canonical_common_profile_refinement_20260912.py', Path(__file__).name]:
