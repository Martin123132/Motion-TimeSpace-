...
from annular_variational_initial_projection_20260916 import variational_initial
...
def main():
    evidence = EvidenceRun('annular-variational-initial-projection-attempt01',__file__)
    try:
