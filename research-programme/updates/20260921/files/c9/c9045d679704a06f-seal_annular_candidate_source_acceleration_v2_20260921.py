...
def main():
    ...
    prefix = 'annular-candidate-source-acceleration-v2'
    ...
    try:
        ...
        report.update(state='complete',completed_at=datetime.now(timezone.utc).isoformat(),
            ...
            distinct_files_rehashed=len(hashes),total_failed_attempts_preserved=prior['total_failed_attempts_preserved']+1,
