...
def run():
    ...
    from annular_cubic_lapse_boundary_20260912 import CubicContext, CubicPreparation, CubicFields, evaluate_cubic_initial
    ...
    try:
        ...
        for name in ['annular_cubic_lapse_boundary_20260912.py', Path(__file__).name]:
        ...
        for branch in ['GR', 'metric_Gram']:
            ...
            for correction in [False, True]:
                ...
                try:
                    ...
                    archive(label + '_initial_data', {**selected, 'pi_boundary_amplitudes': amplitudes, 'radii': context.basis.radii, 'faces': context.basis.faces, 'lapse_extra_projection': context.family.projection, 'lapse_extra_transform': context.family.transform, 'mass_lift_scales': context.family.mass_scale, 'mass_lift_endpoint_drift': context.family.endpoint_drift})
