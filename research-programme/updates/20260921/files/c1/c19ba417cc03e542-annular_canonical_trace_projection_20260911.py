...
def trace_extension(context, base, family):
    ...
    representer_coefficients = (right.T / singular**2) @ right @ (discrepancy / family_scale).T
    raw_momentum = {}
    for surface in base:
        raw_momentum[surface] = (family[surface] / family_scale - base[surface]['q'] @ projection) @ representer_coefficients
