...
from annular_live_P2_canonical_20260918 import LiveP2System, inverse_momenta, wave_kinematics
...
def main():
    evidence = EvidenceRun('annular-live-P2-canonical-attempt01', __file__)
    try:
        evidence.report.update(actual_finite_P2_banded_inverse=True, continuum_pointwise_momentum_not_substituted=True,
