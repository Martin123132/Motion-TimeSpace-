...
def main():
    ...
    prefix = 'annular-candidate-longer-evolution-v2'
    ...
    try:
        ...
        failed_seal_path = intake/'annular-candidate-longer-evolution-final-integrity.json'
        failed_seal = inherit(failed_seal_path)
        check('failed_csv_export_seal_preserved', failed_seal['state'] == 'failed'
            and 'dictionary update sequence' in failed_seal['error']
            and len(failed_seal['independent_step_checks']) == 48 and len(failed_seal['independent_energy_checks']) == 21)
        new_failures = [str(failed_seal_path.relative_to(root))]
        ...
        for name in ['run_annular_candidate_longer_evolution_20260921.py', 'run_annular_candidate_longer_evolution_v2_20260921.py',
                ...
                'seal_annular_candidate_longer_evolution_20260921.py', 'seal_annular_candidate_longer_evolution_v2_20260921.py']:
