...
from annular_P2_graded_embedding_20260919 import GradedSourceAction, nested_embedding
...
def main():
    evidence = EvidenceRun('annular-P2-graded-source-algebra-attempt03', __file__)
    try:
