...
def main():
    ...
    destination = intake/'annular-full-force-final-integrity-v2.json'
    snapshot = intake/'annular-full-force-resume-snapshot-v2.md'
    executed = intake/'annular-full-force-executed-sealer-v2.py'
    ...
    tables = [intake/('annular-full-force-v2-'+suffix+'.csv') for suffix in suffixes]
    ...
    try:
        ...
        for name in ['annular_full_schur_force_20260919.py','annular_position_action_response_20260919.py',
                ...
                'derive_annular_full_force_transport_v2_20260919.py','seal_annular_full_force_20260919.py','seal_annular_full_force_v2_20260919.py']:
