...
def run():
    ...
    output = intake/'annular-reference-wave-decoupling-independent-attempt01'
    ...
    try:
        ...
        for count in [33,65,129]:
            ...
            check(label+'_layer_quadrature_refinement',quadrature_error<1e-7,float(quadrature_error))
