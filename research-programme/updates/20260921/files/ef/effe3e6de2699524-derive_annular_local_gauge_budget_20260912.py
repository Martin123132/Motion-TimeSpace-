...
def run():
    ...
    try:
        ...
        for branch in ['GR', 'metric_Gram']:
            for modes in [0, 2, 4]:
                print('Gauge work/standard metric polynomial trial: ' + branch + ' modes=' + str(modes), flush=True)
