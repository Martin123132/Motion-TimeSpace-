# 5140 - argument-local outer-collinear preflight and A04 replay
...
`A04` preflight therefore derives the roots first and activates
...
The exact locked job `E040__S512503_N0000__A04__primary24` ends as `COMPLETED_CONVERGED`. It uses
`147` composite intervals and reaches maximum
adaptive relative error `3.27252422208022e-05`
against the unchanged `5e-5` tolerance. The causally corrected value is
`(80.3570715629863+27.796538995332977j)`.

The chart was called `720` times
inside `5292` target-profile evaluations.
...
`post-checkpoint-work/source-intake/functional_rg/5138/A04_KLT_collinear_pole_order_proof.json`. Its deep numerical residue disagreement and regular
...
vanishes. Exactly `1` chart used this certificate; no
