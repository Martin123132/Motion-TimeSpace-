# 508 PPC4161 - DeltaKTF Bound Or Coupling Product Parent Signature

Private checkpoint: `4492`
...
Generated UTC: `2026-07-05T22:59:01+00:00`
...
| requirement_id | profile_id | coupling_cell | mathematical_requirement | required_CDeltaKTF_times_NBprime_max | source_needed | claim_effect_if_met | current_status | valid_for_claim |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| REQ4492_PSEL4489_0_smoothstep_minN4_candidate_1.000000000000000e+09 | PSEL4489_0_smoothstep_minN4_candidate | 1.000000000000000e+09 | Either prove A_DeltaKTF_surface=0, or prove/source C_DeltaKTF*N_Bprime <= required_CDeltaKTF_times_NBprime_max | 1.376467175318575e-22 | parent public-metric projection coefficient C_DeltaKTF and actual profile leakage norm N_Bprime | this DeltaKTF lane would fit inside the 4491 no-cancellation allowance for the listed profile/coupling cell | UNMET_NUMERIC_PARENT_INPUTS | False |
| REQ4492_PSEL4489_0_smoothstep_minN4_candidate_1.000000000000000e+11 | PSEL4489_0_smoothstep_minN4_candidate | 1.000000000000000e+11 | Either prove A_DeltaKTF_surface=0, or prove/source C_DeltaKTF*N_Bprime <= required_CDeltaKTF_times_NBprime_max | 0.000000000000000e+00 | parent public-metric projection coefficient C_DeltaKTF and actual profile leakage norm N_Bprime | this DeltaKTF lane would fit inside the 4491 no-cancellation allowance for the listed profile/coupling cell | UNMET_NUMERIC_PARENT_INPUTS | False |
| REQ4492_PSEL4489_1_balanced_Fpp_jump_1.000000000000000e+11 | PSEL4489_1_balanced_Fpp_jump | 1.000000000000000e+11 | Either prove A_DeltaKTF_surface=0, or prove/source C_DeltaKTF*N_Bprime <= required_CDeltaKTF_times_NBprime_max | 6.149146621007479e-25 | parent public-metric projection coefficient C_DeltaKTF and actual profile leakage norm N_Bprime | this DeltaKTF lane would fit inside the 4491 no-cancellation allowance for the listed profile/coupling cell | UNMET_NUMERIC_PARENT_INPUTS | False |
| REQ4492_PSEL4489_1_min_N4_exact_EL_scan_1.000000000000000e+11 | PSEL4489_1_min_N4_exact_EL_scan | 1.000000000000000e+11 | Either prove A_DeltaKTF_surface=0, or prove/source C_DeltaKTF*N_Bprime <= required_CDeltaKTF_times_NBprime_max | 7.039276084858744e-25 | parent public-metric projection coefficient C_DeltaKTF and actual profile leakage norm N_Bprime | this DeltaKTF lane would fit inside the 4491 no-cancellation allowance for the listed profile/coupling cell | UNMET_NUMERIC_PARENT_INPUTS | False |
