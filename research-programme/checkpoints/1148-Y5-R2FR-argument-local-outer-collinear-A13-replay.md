# 5132 - argument-local outer-collinear preflight and A13 replay
...
`A13` preflight therefore derives the roots first and activates
...
The exact locked job `E040__S512503_N0000__A13__primary24` ends as `COMPLETED_CONVERGED`. It uses
`52` composite intervals and reaches maximum
adaptive relative error `3.120351934123457e-05`
against the unchanged `5e-5` tolerance. The causally corrected value is
`(-99.34336960930257+292.4189481762057j)`.

The chart was called `864` times
inside `1908` target-profile evaluations.
