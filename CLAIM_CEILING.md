...
This repository is a public work-in-progress research programme.
...
A result may only be promoted when it has at least one of:

1. a parent-derived theorem-zero identity;
